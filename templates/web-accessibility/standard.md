...
**WEB-A11Y-001 — Declared assessment scope.** An assessment MUST identify the evaluated web experience, artifact or release revision, covered pages or routes, relevant states, complete processes, and material exclusions. A material exclusion is one capable of affecting applicability, an assessment result, or a conformance claim; examples may include excluded pages, routes, states, processes, variations, technologies, environments, or content sources, but this is illustrative and not an exhaustive taxonomy. Disclosing an exclusion does not by itself make it permissible: scope descriptions MUST NOT exclude a page fragment or process step while asserting conformance for the containing full page or complete process, and disclosure MUST NOT be used to circumvent WCAG's full-page or complete-process conformance requirements. Any difference between the assessment's coverage and an intended conformance claim's scope MUST be explicit.
...
Reliance on a conforming alternate version MUST be supported by reviewable evidence addressing WCAG's applicable source conditions, including: the identification and current revision of both the original content and the alternate; their relationship; the alternate's own scope and complete target assessment; the presence of equivalent information and functionality; matching human-language treatment; currency between the versions; the applicable accessibility-supported reachability route; relevant responsive and language variations; and any remaining applicable WCAG conformance conditions. This does not require page-for-page matching, hosting on the same website, an identical assessment scope, or any particular direct-link mechanism; it requires evidence that the source's actual conditions for that route are met.
...
When automated, manual, assistive-technology, specialist, or reused evidence materially conflicts on the same obligation, the assessment MUST preserve the conflicting observations and MUST either reach and document a reviewable resolution — based on the applicable requirement, its source conditions, the assessed revision and scope, the capability of each method, the environment, the quality of each observation, and competent review — or record the affected conclusion as undetermined. A method label or evaluator convenience MUST NOT silently decide the result. Undetermined status arising from an unresolved material conflict does not suppress an independently established failure found elsewhere in the same assessment.

**WEB-A11Y-008 — Actual manual and assistive-technology results.** Manual and assistive-technology conclusions MUST be supported by performed evaluation or by applicable, reviewable evidence whose reuse is justified under section 7. Relevant interaction, state, language, and environment limitations MUST remain visible. A planned test, a predicted result, or an inaccessible test environment MUST NOT be reported as an observed passing result. Assistive-technology verification MUST address the uses relied upon for accessibility support; this standard does not prescribe a universal browser or device matrix.
...
External and local results are evaluated under their own conditions and can coexist without collapsing into a single figure. When both are assessed, each MUST be reported separately and identify its actual target or version, scope, and conclusion. Any reported failure or uncertainty MUST also identify the specific requirement involved and its supporting basis. For example, a declared scope may be WCAG conforming while local-standard nonconforming (a mandatory local assessment or evidence requirement was not met even though the technical target was independently satisfied); WCAG undetermined while local-standard nonconforming; WCAG nonconforming while local-standard nonconforming; or undetermined on both, where neither conformance nor a specific applicable failure has been established. Separate reporting lets a reader tell whether a stated result concerns the external technical target, this standard's own evidence and assessment discipline, or both.

Missing local evidence MUST NOT be treated as proof of failure of a WCAG success criterion. Once evaluation establishes failure of an applicable mandatory local evidence requirement, that failure MUST be reported as local nonconformance, separately from the external technical result rather than folded into or substituted for it.
...
Before a new or renewed current conformance conclusion is asserted, the assessment MUST also recheck the official errata to the fixed Recommendation published since the last assessment-specific errata-review date when later errata may affect an applicable criterion, definition, or item of evidence, or when the continued relevance of the earlier review cannot be justified. Where no earlier assessment-specific errata-review date exists, a first review MUST be performed before that conclusion and MUST cover entries published since the fixed Recommendation's publication on 12 December 2024. This review is triggered by the conclusion being asserted, not a standing calendar obligation.
...
When an errata review under `WEB-A11Y-016` is performed, the assessment MUST record the errata-review date and source basis, and for each applicable entry its stated classification, applicability to the assessed scope, and assessment consequence, including a reasoned no-effect disposition where applicable. Editorial corrections MUST NOT be allowed to silently alter the fixed conformance requirements. If an editorial correction appears to change the result of an applicable criterion, definition, or item of evidence, the assessment MUST record the apparent discrepancy and MUST either document an adequate resolution based on the fixed Recommendation's text and competent analysis or leave the affected conclusion undetermined. The errata text MUST NOT decide an inadequately resolved conclusion, and independently established failures MUST remain visible. This paragraph does not impose periodic calendar review, and the mutable errata page does not itself become a normative dependency.

### Errata disposition — informative

The [official WCAG 2.2 errata](https://www.w3.org/WAI/WCAG22/errata/) were reviewed as of 2 September 2026. All 17 entries listed after 12 December 2024 were classified Editorial; no substantive correction was listed. Some editorial corrections touch normative wording, so “editorial” does not mean merely visual. They do not replace this standard's dated dependency. W3C's stated errata process withholds normative status from substantive corrections until a revised Recommendation. This snapshot records source-maintenance review performed during template authoring. It does not satisfy an adopter's assessment-specific errata-review duty or establish the review date for a later assessment.
